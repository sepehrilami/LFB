...
sys_msg = B_SYS + "You are a helpful assistant. Aid the user with his questions" + E_SYS
#initalize user message
cmds = B_INST + "Consider the following question, and try to answer it to the best of your abilities." + E_INST
human_msg = cmds + "\nUser: {user_input}"
...
rz = lm.predict(user_input = "Explain game theory in a nutshell")
...
with open('7b-results.txt', 'wb') as file:
